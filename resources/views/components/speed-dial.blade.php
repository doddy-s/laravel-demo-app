<div data-dial-init class="fixed bottom-6 right-6 group">
  <div id="speed-dial-menu-dropdown-alternative"
  ...
  <button type="button" data-dial-toggle="speed-dial-menu-dropdown-alternative"
    ...
    class="flex items-center justify-center ml-auto text-white bg-white rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-gray-800 dark:hover:bg-gray-900 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-gray-900">
