      ...
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <form>
          <div class="relative w-96">
            ...
            <button type="submit"
              class="absolute end-2.5 bottom-2.5 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
